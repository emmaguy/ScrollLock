...
public class ConstructTweetUI
{
	...
	public ConstructTweetUI(ViewHolder holder, ContentResolver contentResolver, String tweetText, String tweetCreatedAt, String tweetUserUsername, String tweetUserProfileUrl, byte[] tweetUserProfileImage, int tweetRetweetCount, long tweetUserUserId, byte[] retweetedByImage, String retweetedByUsername, long retweetedByUserId, String retweetedByUserUrl)
	{
		this.holder = holder;
	...
	private void setOrRetrieveProfilePicture(long userId, String url, String username, byte[] image, ImageView imageViewToUpdate)
	{
